...
public class DataUtil {
	...
	static{
		keywords = new String[]{"abstract", "do", "import", "public", "throws", "boolean",
    ...
    static String[] keywordArray = { "abstract", "break", "case", "catch", "class",
    ...
    static String[] primitiveTypeArray = { "boolean", "char", "byte", "short", "int",
    ...
    static Set<String> primitiveTypeSet = new HashSet<String>(Arrays
