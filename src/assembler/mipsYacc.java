...
public class mipsYacc {
	final int number = 230;
	public String terminals[] = {"#","IDENT","HEXNUM","DECNUM","REGISTER","LOAD","STORE","ROP_3","ROP_2","ROP_1","ROP_0","IOP_3","IOP_2","JOP_2","JOP_1","HOP_1",".CODE",".DATA","SEG",".BYTE",".WORD",".HALF",".SPACE","[","]",":",",","(",")","?"};
	public String nonterminals[] = {"program","decl_list","decl","code_seg","codes","code","code_body","data_seg","datas","data","type_spec","values","value","int_literal"};
	...
	public mipsYacc()
	{
		...
		File f = new File("MipsTable.data");
